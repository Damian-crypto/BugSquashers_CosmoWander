    ...
    return (
        <div class="h-auto">
            <div className="bg-gradient-to-br from-bg-purple-light to-bg-purple-dark sm:bg-white sm:bg-hero-image sm:h-auto sm:bg-cover sm:bg-local bg-center relative" >
                ...
                <div class="h-full w-screen sm:w-2/3 relative inset-x-0 top-0 z-10 flex flex-col items-center justify-center px-6 py-8 mx-auto  lg:py-0">
                    ...
                    <div class="w-full bg-transparent sm:bg-gradient-to-br from-bg-purple-light to-bg-purple-dark sm:rounded-lg sm:shadow border-none sm:mt-6 sm:p-5 ">
                        ...
                        <form class="space-y-4 md:space-y-6 my-4" action="#">
