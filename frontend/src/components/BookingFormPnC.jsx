            ...
            <form class="space-y-4 md:space-y-6" action="#">
                <table class="w-full">
                    ...
                    <tr class="grid gap-4 grid-cols-2">
                        ...
                        <td>
                            <div>
                                <label for="location" class="block mb-2 text-sm font-medium text-orange-light ">Weight of cargo (kgs)</label>
                                <div class="border-l-2 border-orange-light w-full ">
                                    <input type="number" name="location" id="location" class="block w-full p-2.5 bg-white-white  text-white-white sm:text-sm bg-opacity-10 text-opacity-100 font-bold focus:outline-none" />
                                </div>
                            </div>
                ...
                <div class="grid grid-cols-2">
                    <div>
                        <label for="location" class="block mb-2 text-sm font-medium text-orange-light ">Price for person</label>
                        <p class="text-text-beige text-2xl">$90</p>
                    </div>
                    <div>
                        <label for="location" class="block mb-2 text-sm font-medium text-orange-light ">Price for cargo</label>
                        <p class="text-text-beige text-2xl">$600</p>
                    </div>
                </div>
                <div>
                    <label for="location" class="block mb-2 text-sm font-medium text-orange-light ">Total Price</label>
                    <p class="text-text-beige text-2xl">$690</p>
                </div>
                <div>
